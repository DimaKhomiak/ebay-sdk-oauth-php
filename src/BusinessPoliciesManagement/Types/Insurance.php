...
/**
 *
 * @property \DKH\eBaySDK\BusinessPoliciesManagement\Types\Amount $domesticInsuranceFee
 * @property string $domesticInsuranceOption
 * @property string $intlInsuranceOption
 * @property \DKH\eBaySDK\BusinessPoliciesManagement\Types\Amount $intlInsuranceFee
 */
class Insurance extends \DKH\eBaySDK\Types\BaseType
{
    /**
