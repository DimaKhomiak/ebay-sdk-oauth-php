 ...
 * @property \DKH\eBaySDK\BusinessPoliciesManagement\Enums\ProfileType $profileType
 * @property integer $profileVersion
 * @property string $profileDesc
 * @property \DateTime $deletedDate
 * @property integer $siteId
 * @property \DKH\eBaySDK\BusinessPoliciesManagement\Types\CategoryGroups $categoryGroups
 */
class SellerProfile extends \DKH\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'categoryGroups' => [
            'type' => 'DKH\eBaySDK\BusinessPoliciesManagement\Types\CategoryGroups',
            'repeatable' => false,
            'attribute' => false,
