 ...
 * @property \DKH\eBaySDK\BusinessPoliciesManagement\Enums\ErrorSeverity $severity
 * @property \DKH\eBaySDK\BusinessPoliciesManagement\Enums\ErrorCategory $category
 * @property string $message
 * @property string $exceptionId
 * @property \DKH\eBaySDK\BusinessPoliciesManagement\Types\ErrorParameter[] $parameter
 */
class ErrorData extends \DKH\eBaySDK\Types\BaseType
{
    ...
    private static $propertyTypes = [
        ...
        'parameter' => [
            'type' => 'DKH\eBaySDK\BusinessPoliciesManagement\Types\ErrorParameter',
            'repeatable' => true,
            'attribute' => false,
