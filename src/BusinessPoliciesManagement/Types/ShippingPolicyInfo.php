 ...
 * @property \DKH\eBaySDK\BusinessPoliciesManagement\Types\ShippingProfileDiscountInfo $shippingProfileDiscountInfo
 * @property \DKH\eBaySDK\BusinessPoliciesManagement\Types\FreightShipping $freightShipping
 * @property string[] $shipToLocations
 * @property \DKH\eBaySDK\BusinessPoliciesManagement\Types\ShippingPolicyInfoService[] $domesticShippingPolicyInfoService
 * @property \DKH\eBaySDK\BusinessPoliciesManagement\Types\ShippingPolicyInfoService[] $intlShippingPolicyInfoService
 * @property \DKH\eBaySDK\BusinessPoliciesManagement\Types\Insurance $insurance
 * @property string $intlRateTable
 * @property string $domesticRateTable
 * @property \DKH\eBaySDK\BusinessPoliciesManagement\Types\Amount $packagingHandlingCosts
 * @property \DKH\eBaySDK\BusinessPoliciesManagement\Types\Amount $internationalPackagingHandlingCosts
 * @property \DKH\eBaySDK\BusinessPoliciesManagement\Enums\IsoCurrencyCode $shippingPolicyCurrency
 * @property boolean $GlobalShipping
 * @property boolean $EligibleForPickupDropOff
 */
class ShippingPolicyInfo extends \DKH\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'shippingProfileDiscountInfo' => [
            'type' => 'DKH\eBaySDK\BusinessPoliciesManagement\Types\ShippingProfileDiscountInfo',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'shippingProfileDiscountInfo'
        ],
        'freightShipping' => [
            'type' => 'DKH\eBaySDK\BusinessPoliciesManagement\Types\FreightShipping',
            'repeatable' => false,
            'attribute' => false,
        ...
        'domesticShippingPolicyInfoService' => [
            'type' => 'DKH\eBaySDK\BusinessPoliciesManagement\Types\ShippingPolicyInfoService',
            'repeatable' => true,
            'attribute' => false,
        ...
        'insurance' => [
            'type' => 'DKH\eBaySDK\BusinessPoliciesManagement\Types\Insurance',
            'repeatable' => false,
            'attribute' => false,
        ...
        'packagingHandlingCosts' => [
            'type' => 'DKH\eBaySDK\BusinessPoliciesManagement\Types\Amount',
            'repeatable' => false,
            'attribute' => false,
