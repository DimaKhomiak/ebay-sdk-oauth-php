...
use DKH\eBaySDK\Trading\Types;

/**
 * Base class for the Trading service.
 */
class TradingBaseService extends \DKH\eBaySDK\Services\BaseService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \DKH\eBaySDK\Trading\Services\TradingService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string']
    ...
    protected function callOperationAsync($name, \DKH\eBaySDK\Types\BaseType $request, $responseClass)
    {
        ...
        if ($this->getConfig('authorization') !== null) {
             ...
             */
            if (!isset($request->RequesterCredentials)) {
                $request->RequesterCredentials = new \DKH\eBaySDK\Trading\Types\CustomSecurityHeaderType();
            }
