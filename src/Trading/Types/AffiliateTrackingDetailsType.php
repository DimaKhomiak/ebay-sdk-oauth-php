 ...
 * @property \DKH\eBaySDK\Trading\Enums\ApplicationDeviceTypeCodeType $ApplicationDeviceType
 * @property string $AffiliateUserID
 */
class AffiliateTrackingDetailsType extends \DKH\eBaySDK\Types\BaseType
{
    /**
