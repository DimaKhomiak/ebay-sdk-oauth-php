...
/**
 *
 * @property \DKH\eBaySDK\Trading\Enums\StoreCustomListingHeaderDisplayCodeType $DisplayType
 * @property boolean $Logo
 * @property boolean $SearchBox
 * @property \DKH\eBaySDK\Trading\Types\StoreCustomListingHeaderLinkType[] $LinkToInclude
 * @property boolean $AddToFavoriteStores
 * @property boolean $SignUpForStoreNewsletter
 */
class StoreCustomListingHeaderType extends \DKH\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'LinkToInclude' => [
            'type' => 'DKH\eBaySDK\Trading\Types\StoreCustomListingHeaderLinkType',
            'repeatable' => true,
            'attribute' => false,
