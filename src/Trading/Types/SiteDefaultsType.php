...
/**
 *
 * @property \DKH\eBaySDK\Trading\Types\ListingDurationReferenceType[] $ListingDuration
 ...
 * @property \DKH\eBaySDK\Trading\Enums\AdFormatEnabledCodeType $AdFormatEnabled
 ...
 * @property \DKH\eBaySDK\Trading\Enums\ClassifiedAdPaymentMethodEnabledCodeType $ClassifiedAdPaymentMethodEnabled
 * @property boolean $ClassifiedAdShippingMethodEnabled
 * @property \DKH\eBaySDK\Trading\Enums\ClassifiedAdBestOfferEnabledCodeType $ClassifiedAdBestOfferEnabled
 ...
 * @property \DKH\eBaySDK\Trading\Enums\ItemSpecificsEnabledCodeType $ItemSpecificsEnabled
 ...
 * @property \DKH\eBaySDK\Trading\Enums\INEscrowWorkflowTimelineCodeType $INEscrowWorkflowTimeline
 * @property \DKH\eBaySDK\Trading\Types\ListingEnhancementDurationReferenceType $GalleryFeaturedDurations
 * @property boolean $PayPalRequired
 * @property \DKH\eBaySDK\Trading\Enums\AdFormatEnabledCodeType $eBayMotorsProAdFormatEnabled
 ...
 * @property \DKH\eBaySDK\Trading\Enums\ClassifiedAdBestOfferEnabledCodeType $eBayMotorsProBestOfferEnabled
 * @property boolean $eBayMotorsProAutoAcceptEnabled
 * @property boolean $eBayMotorsProAutoDeclineEnabled
 * @property \DKH\eBaySDK\Trading\Enums\ClassifiedAdPaymentMethodEnabledCodeType $eBayMotorsProPaymentMethodCheckOutEnabled
 ...
 * @property \DKH\eBaySDK\Trading\Enums\AdFormatEnabledCodeType $LocalMarketAdFormatEnabled
 ...
 * @property \DKH\eBaySDK\Trading\Enums\ClassifiedAdBestOfferEnabledCodeType $LocalMarketBestOfferEnabled
 * @property boolean $LocalMarketAutoAcceptEnabled
 * @property boolean $LocalMarketAutoDeclineEnabled
 * @property \DKH\eBaySDK\Trading\Enums\ClassifiedAdPaymentMethodEnabledCodeType $LocalMarketPaymentMethodCheckOutEnabled
 ...
 * @property \DKH\eBaySDK\Trading\Enums\GeographicExposureCodeType $SpecialitySubscription
 * @property \DKH\eBaySDK\Trading\Enums\GeographicExposureCodeType $RegularSubscription
 * @property \DKH\eBaySDK\Trading\Enums\GeographicExposureCodeType $PremiumSubscription
 * @property \DKH\eBaySDK\Trading\Enums\GeographicExposureCodeType $NonSubscription
 ...
 * @property \DKH\eBaySDK\Trading\Types\StoreOwnerExtendedListingDurationsType $StoreOwnerExtendedListingDurations
 * @property boolean $ReturnPolicyEnabled
 * @property boolean $HandlingTimeEnabled
 * @property \DKH\eBaySDK\Trading\Types\AmountType $MaxFlatShippingCost
 * @property boolean $MaxFlatShippingCostCBTExempt
 * @property \DKH\eBaySDK\Trading\Types\AmountType $Group1MaxFlatShippingCost
 * @property \DKH\eBaySDK\Trading\Types\AmountType $Group2MaxFlatShippingCost
 * @property \DKH\eBaySDK\Trading\Types\AmountType $Group3MaxFlatShippingCost
 * @property \DKH\eBaySDK\Trading\Enums\BuyerPaymentMethodCodeType[] $PaymentMethod
 * @property boolean $VariationsEnabled
 * @property boolean $FreeGalleryPlusEnabled
 * @property boolean $FreePicturePackEnabled
 * @property \DKH\eBaySDK\Trading\Enums\ItemCompatibilityEnabledCodeType $ItemCompatibilityEnabled
 * @property integer $MinItemCompatibility
 * @property integer $MaxItemCompatibility
 * @property \DKH\eBaySDK\Trading\Enums\ConditionEnabledCodeType $ConditionEnabled
 * @property \DKH\eBaySDK\Trading\Types\ConditionValuesType $ConditionValues
 * @property boolean $ValueCategory
 * @property \DKH\eBaySDK\Trading\Enums\ProductCreationEnabledCodeType $ProductCreationEnabled
 * @property \DKH\eBaySDK\Trading\Enums\ProductIdentiferEnabledCodeType $EANEnabled
 * @property \DKH\eBaySDK\Trading\Enums\ProductIdentiferEnabledCodeType $ISBNEnabled
 * @property \DKH\eBaySDK\Trading\Enums\ProductIdentiferEnabledCodeType $UPCEnabled
 * @property integer $MaxGranularFitmentCount
 * @property string $CompatibleVehicleType
 * @property \DKH\eBaySDK\Trading\Enums\PaymentOptionsGroupEnabledCodeType $PaymentOptionsGroup
 * @property \DKH\eBaySDK\Trading\Enums\ProfileCategoryGroupCodeType $ShippingProfileCategoryGroup
 * @property \DKH\eBaySDK\Trading\Enums\ProfileCategoryGroupCodeType $PaymentProfileCategoryGroup
 * @property \DKH\eBaySDK\Trading\Enums\ProfileCategoryGroupCodeType $ReturnPolicyProfileCategoryGroup
 ...
 * @property \DKH\eBaySDK\Trading\Enums\ProductRequiredEnabledCodeType $ProductRequiredEnabled
 */
class SiteDefaultsType extends \DKH\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        'ListingDuration' => [
            'type' => 'DKH\eBaySDK\Trading\Types\ListingDurationReferenceType',
            'repeatable' => true,
            'attribute' => false,
        ...
        'GalleryFeaturedDurations' => [
            'type' => 'DKH\eBaySDK\Trading\Types\ListingEnhancementDurationReferenceType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'StoreOwnerExtendedListingDurations' => [
            'type' => 'DKH\eBaySDK\Trading\Types\StoreOwnerExtendedListingDurationsType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'ConditionValues' => [
            'type' => 'DKH\eBaySDK\Trading\Types\ConditionValuesType',
            'repeatable' => false,
            'attribute' => false,
