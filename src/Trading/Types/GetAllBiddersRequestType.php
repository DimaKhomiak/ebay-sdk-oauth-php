 ...
 * @property \DKH\eBaySDK\Trading\Enums\GetAllBiddersModeCodeType $CallMode
 * @property boolean $IncludeBiddingSummary
 */
class GetAllBiddersRequestType extends \DKH\eBaySDK\Trading\Types\AbstractRequestType
{
    /**
