 ...
 * @property \DKH\eBaySDK\Trading\Enums\CurrencyCodeType $BillingCurrency
 ...
 * @property \DKH\eBaySDK\Trading\Enums\SellerLevelCodeType $SellerLevel
 * @property \DKH\eBaySDK\Trading\Types\AddressType $SellerPaymentAddress
 * @property \DKH\eBaySDK\Trading\Types\SchedulingInfoType $SchedulingInfo
 * @property boolean $StoreOwner
 * @property string $StoreURL
 * @property \DKH\eBaySDK\Trading\Enums\SellerBusinessCodeType $SellerBusinessType
 * @property boolean $RegisteredBusinessSeller
 * @property \DKH\eBaySDK\Trading\Enums\SiteCodeType $StoreSite
 * @property \DKH\eBaySDK\Trading\Enums\SellerPaymentMethodCodeType $PaymentMethod
 * @property boolean $CharityRegistered
 * @property boolean $SafePaymentExempt
 * @property integer $PaisaPayEscrowEMIStatus
 * @property \DKH\eBaySDK\Trading\Types\CharityAffiliationDetailsType $CharityAffiliationDetails
 * @property double $TransactionPercent
 * @property \DKH\eBaySDK\Trading\Types\IntegratedMerchantCreditCardInfoType $IntegratedMerchantCreditCardInfo
 * @property \DKH\eBaySDK\Trading\Types\FeatureEligibilityType $FeatureEligibility
 * @property boolean $TopRatedSeller
 * @property \DKH\eBaySDK\Trading\Types\TopRatedSellerDetailsType $TopRatedSellerDetails
 * @property \DKH\eBaySDK\Trading\Types\RecoupmentPolicyConsentType $RecoupmentPolicyConsent
...
class SellerType extends \DKH\eBaySDK\Types\BaseType
{
    ...
    private static $propertyTypes = [
        ...
        'SchedulingInfo' => [
            'type' => 'DKH\eBaySDK\Trading\Types\SchedulingInfoType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'CharityAffiliationDetails' => [
            'type' => 'DKH\eBaySDK\Trading\Types\CharityAffiliationDetailsType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'IntegratedMerchantCreditCardInfo' => [
            'type' => 'DKH\eBaySDK\Trading\Types\IntegratedMerchantCreditCardInfoType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'IntegratedMerchantCreditCardInfo'
        ],
        'FeatureEligibility' => [
            'type' => 'DKH\eBaySDK\Trading\Types\FeatureEligibilityType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'TopRatedSellerDetails' => [
            'type' => 'DKH\eBaySDK\Trading\Types\TopRatedSellerDetailsType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'TopRatedSellerDetails'
        ],
        'RecoupmentPolicyConsent' => [
            'type' => 'DKH\eBaySDK\Trading\Types\RecoupmentPolicyConsentType',
            'repeatable' => false,
            'attribute' => false,
