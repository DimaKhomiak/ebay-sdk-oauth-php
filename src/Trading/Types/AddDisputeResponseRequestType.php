 ...
 * @property \DKH\eBaySDK\Trading\Enums\DisputeActivityCodeType $DisputeActivity
 * @property string $ShippingCarrierUsed
 * @property string $ShipmentTrackNumber
 * @property \DateTime $ShippingTime
 */
class AddDisputeResponseRequestType extends \DKH\eBaySDK\Trading\Types\AbstractRequestType
{
    /**
