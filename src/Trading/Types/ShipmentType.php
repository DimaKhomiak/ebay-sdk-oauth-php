 ...
 * @property \DKH\eBaySDK\Trading\Types\AmountType $InsuredValue
 * @property \DKH\eBaySDK\Trading\Types\MeasureType $PackageDepth
 * @property \DKH\eBaySDK\Trading\Types\MeasureType $PackageLength
 * @property \DKH\eBaySDK\Trading\Types\MeasureType $PackageWidth
 * @property string $PayPalShipmentID
 * @property integer $ShipmentID
 * @property \DKH\eBaySDK\Trading\Types\AmountType $PostageTotal
 * @property \DateTime $PrintedTime
 * @property \DKH\eBaySDK\Trading\Types\AddressType $ShipFromAddress
 * @property \DKH\eBaySDK\Trading\Types\AddressType $ShippingAddress
 * @property \DKH\eBaySDK\Trading\Enums\ShippingFeatureCodeType[] $ShippingFeature
 * @property \DKH\eBaySDK\Trading\Enums\ShippingPackageCodeType $ShippingPackage
 * @property string $ShippingServiceUsed
 * @property \DKH\eBaySDK\Trading\Types\MeasureType $WeightMajor
 * @property \DKH\eBaySDK\Trading\Types\MeasureType $WeightMinor
 * @property \DKH\eBaySDK\Trading\Types\ItemTransactionIDType[] $ItemTransactionID
 * @property \DateTime $DeliveryDate
 * @property \DKH\eBaySDK\Trading\Enums\ShipmentDeliveryStatusCodeType $DeliveryStatus
 * @property \DateTime $RefundGrantedTime
 * @property \DateTime $RefundRequestedTime
 * @property \DKH\eBaySDK\Trading\Enums\ShipmentStatusCodeType $Status
 * @property \DateTime $ShippedTime
 * @property \DKH\eBaySDK\Trading\Types\ShipmentTrackingDetailsType[] $ShipmentTrackingDetails
 * @property \DKH\eBaySDK\Trading\Types\ShipmentLineItemType $ShipmentLineItem
 */
class ShipmentType extends \DKH\eBaySDK\Types\BaseType
{
    ...
    private static $propertyTypes = [
        ...
        'ItemTransactionID' => [
            'type' => 'DKH\eBaySDK\Trading\Types\ItemTransactionIDType',
            'repeatable' => true,
            'attribute' => false,
        ...
        'ShipmentLineItem' => [
            'type' => 'DKH\eBaySDK\Trading\Types\ShipmentLineItemType',
            'repeatable' => false,
            'attribute' => false,
