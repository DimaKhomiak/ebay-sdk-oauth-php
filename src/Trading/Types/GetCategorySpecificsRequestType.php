 ...
 * @property \DKH\eBaySDK\Trading\Types\CategoryItemSpecificsType[] $CategorySpecific
 * @property boolean $ExcludeRelationships
 * @property boolean $IncludeConfidence
 * @property boolean $CategorySpecificsFileInfo
 */
class GetCategorySpecificsRequestType extends \DKH\eBaySDK\Trading\Types\AbstractRequestType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'CategorySpecific' => [
            'type' => 'DKH\eBaySDK\Trading\Types\CategoryItemSpecificsType',
            'repeatable' => true,
            'attribute' => false,
