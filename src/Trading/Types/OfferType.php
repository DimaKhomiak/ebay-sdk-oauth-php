...
/**
 *
 * @property \DKH\eBaySDK\Trading\Enums\BidActionCodeType $Action
 * @property \DKH\eBaySDK\Trading\Enums\CurrencyCodeType $Currency
 * @property \DKH\eBaySDK\Trading\Types\AmountType $MaxBid
 * @property integer $Quantity
 * @property boolean $SecondChanceEnabled
 * @property \DKH\eBaySDK\Trading\Enums\CurrencyCodeType $SiteCurrency
 * @property \DateTime $TimeBid
 * @property \DKH\eBaySDK\Trading\Types\AmountType $HighestBid
 * @property \DKH\eBaySDK\Trading\Types\AmountType $ConvertedPrice
 * @property \DKH\eBaySDK\Trading\Types\UserType $User
 * @property boolean $UserConsent
 * @property string $Message
 * @property string $BestOfferID
 * @property \DKH\eBaySDK\Trading\Types\AmountType $MyMaxBid
 */
class OfferType extends \DKH\eBaySDK\Types\BaseType
{
    /**
