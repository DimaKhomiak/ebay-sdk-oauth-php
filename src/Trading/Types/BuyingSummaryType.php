 ...
 * @property \DKH\eBaySDK\Trading\Types\AmountType $TotalWinningCost
 * @property integer $WonCount
 * @property \DKH\eBaySDK\Trading\Types\AmountType $TotalWonCost
 * @property integer $WonDurationInDays
 * @property integer $BestOfferCount
 */
class BuyingSummaryType extends \DKH\eBaySDK\Types\BaseType
{
    /**
