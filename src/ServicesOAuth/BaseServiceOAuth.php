 ...
 */
abstract class BaseServiceOAuth
{
    /**
     ...
     *
     * @return Functions\CredentialsOAuth\CredentialsOAuthInterface
     */
     ...
     * @param Functions\Types\BaseType $request Request object containing the request information.
     ...
     */
    protected function callOperationAsync($name, Functions\Types\BaseType $request, $responseClass)
    {
        $url = $this->getUrl();
     ...
     */
    protected function buildRequestBody(Functions\Types\BaseType $request)
    {
     ...
     */
    private function buildXopDocument(Functions\Types\BaseType $request)
    {
        return sprintf(
            '%s%s%s%s%s',
     ...
     */
    protected function buildMultipartFormDataXMLPayload(Functions\Types\BaseType $request)
    {
        return sprintf(
            '%s%s%s',
            '--boundary' . self::CRLF,
