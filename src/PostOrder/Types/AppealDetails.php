 ...
 * @property \DKH\eBaySDK\PostOrder\Types\DateTime $appealDate
 * @property string $appealReasonCode
 * @property string $appealStatus
 * @property \DKH\eBaySDK\PostOrder\Enums\AppealStatusEnum $appealStatusEnum
 * @property boolean $eligibleForAppeal
 */
class AppealDetails extends \DKH\eBaySDK\Types\BaseType
{
    /**
