...
/**
 *
 * @property \DKH\eBaySDK\PostOrder\Types\DateTime $holdCreationDate
 * @property string $holdReferenceId
 * @property \DKH\eBaySDK\PostOrder\Types\DateTime $holdReleaseDate
 * @property \DKH\eBaySDK\PostOrder\Enums\ReturnHoldStatusEnum $holdStatus
 * @property string $holdTransactionId
 */
class ReturnHoldInfoType extends \DKH\eBaySDK\Types\BaseType
{
    /**
