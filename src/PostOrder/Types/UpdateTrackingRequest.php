...
/**
 *
 * @property \DKH\eBaySDK\PostOrder\Enums\ShippingCarrierEnum $newCarrierEnum
 * @property string $newCarrierName
 * @property string $newTrackingNumber
 * @property \DKH\eBaySDK\PostOrder\Enums\ShippingCarrierEnum $usedCarrierEnum
 * @property string $usedCarrierName
 * @property string $usedTrackingNumber
 */
class UpdateTrackingRequest extends \DKH\eBaySDK\Types\BaseType
{
    /**
