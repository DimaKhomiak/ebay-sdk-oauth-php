<?php
namespace DKH\eBaySDK\Services;
...
abstract class BaseService
{
     ...
     */
    protected function buildRequestBody(\DKH\eBaySDK\Types\BaseType $request)
    {
     ...
     */
    private function buildXopDocument(\DKH\eBaySDK\Types\BaseType $request)
    {
        return sprintf(
            '%s%s%s%s%s',
     ...
     */
    protected function buildMultipartFormDataXMLPayload(\DKH\eBaySDK\Types\BaseType $request)
    {
        return sprintf(
            '%s%s%s',
            '--boundary'.self::CRLF,
