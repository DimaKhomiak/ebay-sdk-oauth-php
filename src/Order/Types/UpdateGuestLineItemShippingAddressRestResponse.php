...
/**
 *
 * @property \DKH\eBaySDK\Order\Types\ErrorDetailV3[] $errors
 * @property \DKH\eBaySDK\Order\Types\ErrorDetailV3[] $warnings
 */
class UpdateGuestLineItemShippingAddressRestResponse extends \DKH\eBaySDK\Order\Types\CheckoutSessionResponse
{
    use StatusCodeTrait;
