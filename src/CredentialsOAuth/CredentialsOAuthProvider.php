 ...
 * instance that implements DKH\eBaySDK\Credentials\CredentialsInterface. If they
 ...
 */
class CredentialsOAuthProvider
{
    ...
    const ENV_IAF_TOKEN = 'EBAY_SDK_IAF_TOKEN';
    ...
    public static function env()
    {
        return function () {
            ...
            $iafToken = getenv(self::ENV_IAF_TOKEN);

            if ($appId && $certId && $devId) {
                return new CredentialsOAuth($appId, $certId, $devId, $iafToken);
            } else {
