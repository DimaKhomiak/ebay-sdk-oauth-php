 ...
 * @property \DKH\eBaySDK\MerchantData\Enums\CountryCodeType $PhoneCountryCode
 * @property string $PhoneCountryPrefix
 * @property string $PhoneAreaOrCityCode
 * @property string $PhoneLocalNumber
 * @property \DKH\eBaySDK\MerchantData\Enums\CountryCodeType $Phone2CountryCode
 * @property string $Phone2CountryPrefix
 * @property string $Phone2AreaOrCityCode
 * @property string $Phone2LocalNumber
 * @property string $PostalCode
 * @property string $AddressID
 * @property \DKH\eBaySDK\MerchantData\Enums\AddressOwnerCodeType $AddressOwner
 ...
 * @property \DKH\eBaySDK\MerchantData\Enums\AddressUsageCodeType $AddressUsage
 * @property string $ReferenceID
 * @property \DKH\eBaySDK\MerchantData\Types\AddressAttributeType[] $AddressAttribute
 */
class AddressType extends \DKH\eBaySDK\Types\BaseType
{
    ...
    private static $propertyTypes = [
        ...
        'AddressAttribute' => [
            'type' => 'DKH\eBaySDK\MerchantData\Types\AddressAttributeType',
            'repeatable' => true,
            'attribute' => false,
