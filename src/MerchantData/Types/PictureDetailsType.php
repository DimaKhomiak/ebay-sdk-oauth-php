...
/**
 *
 * @property \DKH\eBaySDK\MerchantData\Enums\GalleryTypeCodeType $GalleryType
 * @property string $GalleryURL
 * @property \DKH\eBaySDK\MerchantData\Enums\PhotoDisplayCodeType $PhotoDisplay
 * @property string[] $PictureURL
 * @property \DKH\eBaySDK\MerchantData\Enums\PictureSourceCodeType $PictureSource
 * @property string $GalleryDuration
 * @property \DKH\eBaySDK\MerchantData\Enums\GalleryStatusCodeType $GalleryStatus
 * @property string $GalleryErrorInfo
 * @property string[] $ExternalPictureURL
 * @property \DKH\eBaySDK\MerchantData\Types\ExtendedPictureDetailsType $ExtendedPictureDetails
 */
class PictureDetailsType extends \DKH\eBaySDK\Types\BaseType
{
    ...
    private static $propertyTypes = [
        ...
        'ExtendedPictureDetails' => [
            'type' => 'DKH\eBaySDK\MerchantData\Types\ExtendedPictureDetailsType',
            'repeatable' => false,
            'attribute' => false,
