 ...
 * @property \DKH\eBaySDK\MerchantData\Types\AmountType $BidIncrement
 * @property \DKH\eBaySDK\MerchantData\Types\AmountType $ConvertedCurrentPrice
 * @property \DKH\eBaySDK\MerchantData\Types\AmountType $CurrentPrice
 * @property \DKH\eBaySDK\MerchantData\Types\UserType $HighBidder
 * @property integer $LeadCount
 * @property \DKH\eBaySDK\MerchantData\Types\AmountType $MinimumToBid
 * @property integer $QuantitySold
 * @property boolean $ReserveMet
 * @property boolean $SecondChanceEligible
 * @property integer $BidderCount
 * @property \DKH\eBaySDK\MerchantData\Enums\ListingStatusCodeType $ListingStatus
 * @property \DKH\eBaySDK\MerchantData\Types\AmountType $FinalValueFee
 * @property \DKH\eBaySDK\MerchantData\Types\PromotionalSaleDetailsType $PromotionalSaleDetails
 * @property boolean $AdminEnded
 * @property boolean $SoldAsBin
 * @property integer $QuantitySoldByPickupInStore
 * @property \DKH\eBaySDK\MerchantData\Types\SuggestedBidValueType $SuggestedBidValues
 */
class SellingStatusType extends \DKH\eBaySDK\Types\BaseType
{
    ...
    private static $propertyTypes = [
        ...
        'PromotionalSaleDetails' => [
            'type' => 'DKH\eBaySDK\MerchantData\Types\PromotionalSaleDetailsType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'SuggestedBidValues' => [
            'type' => 'DKH\eBaySDK\MerchantData\Types\SuggestedBidValueType',
            'repeatable' => false,
            'attribute' => false,
