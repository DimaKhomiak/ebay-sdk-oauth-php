 ...
 * @property string $UPC
 * @property string $EAN
 * @property \DKH\eBaySDK\MerchantData\Types\BrandMPNType $BrandMPN
 * @property \DKH\eBaySDK\MerchantData\Types\TicketListingDetailsType $TicketListingDetails
 * @property boolean $UseFirstProduct
 * @property boolean $IncludeeBayProductDetails
 */
class ProductListingDetailsType extends \DKH\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'BrandMPN' => [
            'type' => 'DKH\eBaySDK\MerchantData\Types\BrandMPNType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'BrandMPN'
        ],
        'TicketListingDetails' => [
            'type' => 'DKH\eBaySDK\MerchantData\Types\TicketListingDetailsType',
            'repeatable' => false,
            'attribute' => false,
