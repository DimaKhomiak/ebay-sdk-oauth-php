 ...
 * @property \DKH\eBaySDK\MerchantData\Types\AmountType $ConvertedBuyItNowPrice
 * @property \DKH\eBaySDK\MerchantData\Types\AmountType $ConvertedStartPrice
 * @property \DKH\eBaySDK\MerchantData\Types\AmountType $ConvertedReservePrice
 ...
 * @property \DKH\eBaySDK\MerchantData\Types\AmountType $MinimumBestOfferPrice
 * @property string $LocalListingDistance
 * @property string $TCROriginalItemID
 * @property string $ViewItemURLForNaturalSearch
 * @property \DKH\eBaySDK\MerchantData\Types\AmountType $BestOfferAutoAcceptPrice
 * @property \DKH\eBaySDK\MerchantData\Enums\EndReasonCodeType $EndingReason
 */
class ListingDetailsType extends \DKH\eBaySDK\Types\BaseType
{
    /**
