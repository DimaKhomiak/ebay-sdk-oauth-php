 ...
 * @property \DKH\eBaySDK\MerchantData\Enums\CharityAffiliationTypeCodeType $AffiliationType
 * @property \DateTime $LastUsedTime
 */
class CharityAffiliationDetailType extends \DKH\eBaySDK\Types\BaseType
{
    /**
