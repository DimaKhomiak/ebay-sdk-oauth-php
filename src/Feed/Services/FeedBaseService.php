<?php
namespace DKH\eBaySDK\Feed\Services;

/**
 * Base class for the Feed service.
 */
class FeedBaseService extends \DKH\eBaySDK\Services\BaseRestService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \DKH\eBaySDK\Feed\Services\FeedService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string'],
