 ...
 * @property \DKH\eBaySDK\Account\Enums\RefundMethodEnum $refundMethod
 * @property string $restockingFeePercentage
 * @property string $returnInstructions
 * @property \DKH\eBaySDK\Account\Enums\ReturnMethodEnum $returnMethod
 * @property \DKH\eBaySDK\Account\Types\TimeDuration $returnPeriod
 * @property string $returnPolicyId
 * @property boolean $returnsAccepted
 * @property \DKH\eBaySDK\Account\Enums\ReturnShippingCostPayerEnum $returnShippingCostPayer
 * @property \DKH\eBaySDK\Account\Types\ErrorDetailV3[] $warnings
 */
class SetReturnPolicyResponse extends \DKH\eBaySDK\Types\BaseType
{
    /**
