...
/**
 *
 * @property \DKH\eBaySDK\Account\Types\Amount $maxSoldInventoryValue
 * @property integer $maxSoldQuantity
 * @property \DKH\eBaySDK\Account\Types\Amount $minSoldInventoryValue
 * @property integer $minSoldQuantity
 * @property \DKH\eBaySDK\Account\Types\TimeDuration $period
 */
class SoldAggregatedMetrics extends \DKH\eBaySDK\Types\BaseType
{
    /**
