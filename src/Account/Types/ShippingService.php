...
/**
 *
 * @property \DKH\eBaySDK\Account\Types\Amount $additionalShippingCost
 * @property boolean $buyerResponsibleForPickup
 * @property boolean $buyerResponsibleForShipping
 * @property \DKH\eBaySDK\Account\Types\Amount $cashOnDeliveryFee
 * @property boolean $freeShipping
 * @property string $shippingCarrierCode
 * @property \DKH\eBaySDK\Account\Types\Amount $shippingCost
 * @property string $shippingServiceCode
 * @property \DKH\eBaySDK\Account\Types\RegionSet $shipToLocations
 * @property integer $sortOrder
 * @property \DKH\eBaySDK\Account\Types\Amount $surcharge
 */
class ShippingService extends \DKH\eBaySDK\Types\BaseType
{
    /**
