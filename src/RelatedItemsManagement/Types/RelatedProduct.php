 ...
 *
 * @property string $SKU
 * @property \DKH\eBaySDK\RelatedItemsManagement\Types\Discount $discount
 * @property integer $rank
 * @property string $title
 * @property integer $maxQtyForSinglePrimary
 */
class RelatedProduct extends \DKH\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'discount' => [
            'type' => 'DKH\eBaySDK\RelatedItemsManagement\Types\Discount',
            'repeatable' => false,
            'attribute' => false,
