...
/**
 *
 * @property \DKH\eBaySDK\RelatedItemsManagement\Types\RelatedProduct[] $relatedProduct
 * @property string $groupName
 * @property integer $rank
 * @property boolean $singleRelatedSKUPurchaseOnly
 */
class RelatedProductGroup extends \DKH\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        'relatedProduct' => [
            'type' => 'DKH\eBaySDK\RelatedItemsManagement\Types\RelatedProduct',
            'repeatable' => true,
            'attribute' => false,
