 ...
 */
class RelatedItemsManagementBaseService extends \DKH\eBaySDK\Services\BaseService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \DKH\eBaySDK\RelatedItemsManagement\Services\RelatedItemsManagementService::API_VERSION
            ],
            'authToken' => [
                'valid' => ['string'],
                'required' => true
