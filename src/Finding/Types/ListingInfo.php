 ...
 * @property \DKH\eBaySDK\Finding\Types\Amount $buyItNowPrice
 * @property \DKH\eBaySDK\Finding\Types\Amount $convertedBuyItNowPrice
 * @property \DateTime $startTime
 * @property \DateTime $endTime
 * @property string $listingType
 * @property boolean $gift
 */
class ListingInfo extends \DKH\eBaySDK\Types\BaseType
{
    /**
