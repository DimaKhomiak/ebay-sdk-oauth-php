 ...
 * @property \DKH\eBaySDK\Shopping\Types\AmountType $BuyItNowPrice
 * @property string $Description
 * @property string $ItemID
 * @property boolean $BuyItNowAvailable
 * @property \DKH\eBaySDK\Shopping\Types\AmountType $ConvertedBuyItNowPrice
 * @property \DateTime $EndTime
 * @property \DateTime $StartTime
 * @property string $ViewItemURLForNaturalSearch
 * @property \DKH\eBaySDK\Shopping\Enums\ListingTypeCodeType $ListingType
 * @property string $Location
 * @property \DKH\eBaySDK\Shopping\Enums\BuyerPaymentMethodCodeType[] $PaymentMethods
 ...
 * @property \DKH\eBaySDK\Shopping\Types\SimpleUserType $Seller
 * @property integer $BidCount
 * @property \DKH\eBaySDK\Shopping\Types\AmountType $ConvertedCurrentPrice
 * @property \DKH\eBaySDK\Shopping\Types\AmountType $CurrentPrice
 * @property \DKH\eBaySDK\Shopping\Types\SimpleUserType $HighBidder
 * @property \DKH\eBaySDK\Shopping\Enums\ListingStatusCodeType $ListingStatus
 * @property integer $QuantitySold
 * @property boolean $ReserveMet
 * @property string[] $ShipToLocations
 * @property \DKH\eBaySDK\Shopping\Enums\SiteCodeType $Site
 * @property string $TimeLeft
 * @property string $Title
 * @property \DKH\eBaySDK\Shopping\Types\ShippingCostSummaryType $ShippingCostSummary
 * @property \DKH\eBaySDK\Shopping\Types\NameValueListArrayType $ItemSpecifics
 ...
 * @property \DKH\eBaySDK\Shopping\Types\CharityType $Charity
 * @property \DKH\eBaySDK\Shopping\Types\StorefrontType $Storefront
 * @property \DKH\eBaySDK\Shopping\Enums\CountryCodeType $Country
 * @property \DKH\eBaySDK\Shopping\Enums\HalfItemConditionCodeType $HalfItemCondition
 * @property string $SellerComments
 * @property \DKH\eBaySDK\Shopping\Types\ReturnPolicyType $ReturnPolicy
 * @property \DKH\eBaySDK\Shopping\Types\AmountType $MinimumToBid
 * @property \DKH\eBaySDK\Shopping\Types\ProductIDType $ProductID
 * @property boolean $AutoPay
 * @property \DKH\eBaySDK\Shopping\Types\BusinessSellerDetailsType $BusinessSellerDetails
 * @property \DKH\eBaySDK\Shopping\Enums\SiteCodeType[] $PaymentAllowedSite
 * @property boolean $IntegratedMerchantCreditCardEnabled
 * @property \DKH\eBaySDK\Shopping\Types\VariationsType $Variations
 * @property integer $HandlingTime
 * @property integer $LotSize
 * @property integer $ConditionID
 * @property string $ConditionDisplayName
 * @property \DKH\eBaySDK\Shopping\Enums\QuantityAvailableHintCodeType $QuantityAvailableHint
 * @property integer $QuantityThreshold
 * @property \DKH\eBaySDK\Shopping\Types\DiscountPriceInfoType $DiscountPriceInfo
 * @property string[] $ExcludeShipToLocation
 * @property boolean $TopRatedListing
 * @property string $VhrUrl
 * @property boolean $VhrAvailable
 * @property \DKH\eBaySDK\Shopping\Types\QuantityInfo $QuantityInfo
 * @property \DKH\eBaySDK\Shopping\Types\UnitInfoType $UnitInfo
 * @property boolean $GlobalShipping
 * @property string $ConditionDescription
 * @property integer $ItemCompatibilityCount
 * @property \DKH\eBaySDK\Shopping\Types\ItemCompatibilityListType $ItemCompatibilityList
 ...
 */
class SimpleItemType extends \DKH\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'ItemSpecifics' => [
            'type' => 'DKH\eBaySDK\Shopping\Types\NameValueListArrayType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'Charity' => [
            'type' => 'DKH\eBaySDK\Shopping\Types\CharityType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'Charity'
        ],
        'Storefront' => [
            'type' => 'DKH\eBaySDK\Shopping\Types\StorefrontType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'ReturnPolicy' => [
            'type' => 'DKH\eBaySDK\Shopping\Types\ReturnPolicyType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'ProductID' => [
            'type' => 'DKH\eBaySDK\Shopping\Types\ProductIDType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'BusinessSellerDetails' => [
            'type' => 'DKH\eBaySDK\Shopping\Types\BusinessSellerDetailsType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'Variations' => [
            'type' => 'DKH\eBaySDK\Shopping\Types\VariationsType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'DiscountPriceInfo' => [
            'type' => 'DKH\eBaySDK\Shopping\Types\DiscountPriceInfoType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'QuantityInfo' => [
            'type' => 'DKH\eBaySDK\Shopping\Types\QuantityInfo',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'QuantityInfo'
        ],
        'UnitInfo' => [
            'type' => 'DKH\eBaySDK\Shopping\Types\UnitInfoType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'ItemCompatibilityList' => [
            'type' => 'DKH\eBaySDK\Shopping\Types\ItemCompatibilityListType',
            'repeatable' => false,
            'attribute' => false,
