 ...
 * @property \DKH\eBaySDK\Shopping\Enums\ProductSortCodeType $ProductSort
 * @property \DKH\eBaySDK\Shopping\Enums\SortOrderCodeType $SortOrder
 * @property integer $MaxEntries
 * @property integer $PageNumber
 * @property string $CategoryID
 * @property boolean $HideDuplicateItems
 */
class FindProductsRequestType extends \DKH\eBaySDK\Shopping\Types\AbstractRequestType
{
    /**
