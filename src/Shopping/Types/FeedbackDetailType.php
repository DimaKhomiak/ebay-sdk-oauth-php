 ...
 * @property \DKH\eBaySDK\Shopping\Enums\CommentTypeCodeType $CommentType
 * @property string $FeedbackResponse
 * @property string $FollowUp
 * @property string $ItemID
 * @property \DKH\eBaySDK\Shopping\Enums\TradingRoleCodeType $Role
 * @property string $ItemTitle
 * @property \DKH\eBaySDK\Shopping\Types\AmountType $ItemPrice
