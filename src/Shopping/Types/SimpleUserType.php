 ...
 * @property \DKH\eBaySDK\Shopping\Enums\FeedbackRatingStarCodeType $FeedbackRatingStar
 * @property integer $FeedbackScore
 * @property boolean $UserAnonymized
 * @property boolean $NewUser
 * @property \DateTime $RegistrationDate
 * @property \DKH\eBaySDK\Shopping\Enums\SiteCodeType $RegistrationSite
 * @property \DKH\eBaySDK\Shopping\Enums\UserStatusCodeType $Status
 * @property \DKH\eBaySDK\Shopping\Enums\SellerBusinessCodeType $SellerBusinessType
 ...
 * @property \DKH\eBaySDK\Shopping\Enums\SellerLevelCodeType $SellerLevel
 * @property boolean $TopRatedSeller
 */
class SimpleUserType extends \DKH\eBaySDK\Types\BaseType
{
    /**
