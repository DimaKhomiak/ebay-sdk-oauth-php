...
class ShoppingBaseServiceOAuth extends \DTS\eBaySDK\ServicesOAuth\BaseServiceOAuth
{
    ...
    /**
     * HTTP header constant. Your application access_token.
     */
    const HDR_IAF_TOKEN  = 'X-EBAY-API-IAF-TOKEN';
    ...
    protected function getEbayHeaders($operationName)
    {
        ...
        $headers[self::HDR_IAF_TOKEN] = $this->getConfig('credentials')->getIafToken();
