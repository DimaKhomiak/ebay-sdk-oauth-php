...
/**
 *
 * @property \DKH\eBaySDK\Marketing\Types\Amount $amountOffItem
 * @property \DKH\eBaySDK\Marketing\Types\Amount $amountOffOrder
 * @property string $percentageOffItem
 * @property string $percentageOffOrder
 */
class DiscountBenefit extends \DKH\eBaySDK\Types\BaseType
{
    /**
