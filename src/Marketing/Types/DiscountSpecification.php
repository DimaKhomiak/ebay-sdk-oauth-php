...
/**
 *
 * @property \DKH\eBaySDK\Marketing\Types\Amount $forEachAmount
 * @property integer $forEachQuantity
 * @property \DKH\eBaySDK\Marketing\Types\Amount $minAmount
 * @property integer $minQuantity
 * @property integer $numberOfDiscountedItems
 */
class DiscountSpecification extends \DKH\eBaySDK\Types\BaseType
{
    /**
