 ...
 */
class ResolutionCaseManagementBaseService extends \DKH\eBaySDK\Services\BaseService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \DKH\eBaySDK\ResolutionCaseManagement\Services\ResolutionCaseManagementService::API_VERSION
            ],
            'authToken' => [
                'valid' => ['string'],
                'required' => true
