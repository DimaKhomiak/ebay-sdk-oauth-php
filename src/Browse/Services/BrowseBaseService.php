<?php
namespace DKH\eBaySDK\Browse\Services;

/**
 * Base class for the Browse service.
 */
class BrowseBaseService extends \DKH\eBaySDK\Services\BaseRestService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            ...
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \DKH\eBaySDK\Browse\Services\BrowseService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string'],
