...
/**
 *
 * @property \DKH\eBaySDK\Browse\Types\Image[] $itemGroupAdditionalImages
 * @property string $itemGroupHref
 * @property string $itemGroupId
 * @property \DKH\eBaySDK\Browse\Types\Image $itemGroupImage
 * @property string $itemGroupTitle
 * @property \DKH\eBaySDK\Browse\Enums\ItemGroupTypeEnum $itemGroupType
 */
class ItemGroupSummary extends \DKH\eBaySDK\Types\BaseType
{
    /**
