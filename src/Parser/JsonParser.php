...
{
    /**
     * @param mixed A PHP object derived from DKH\eBaySDK\Types\BaseType
    ...
    private static function assignProperties(\DKH\eBaySDK\Types\BaseType $object, array $properties)
    {
