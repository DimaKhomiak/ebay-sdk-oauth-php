...
class XmlParser
{
     ...
     *
     * @return mixed A PHP object derived from DKH\eBaySDK\Types\BaseType
     */
    ...
    {
        return (
            is_subclass_of($meta->phpObject, '\DKH\eBaySDK\Types\Base64BinaryType', false) ||
            is_subclass_of($meta->phpObject, '\DKH\eBaySDK\Types\BooleanType', false) ||
            is_subclass_of($meta->phpObject, '\DKH\eBaySDK\Types\DecimalType', false) ||
            is_subclass_of($meta->phpObject, '\DKH\eBaySDK\Types\DoubleType', false) ||
            is_subclass_of($meta->phpObject, '\DKH\eBaySDK\Types\IntegerType', false) ||
            is_subclass_of($meta->phpObject, '\DKH\eBaySDK\Types\StringType', false) ||
            is_subclass_of($meta->phpObject, '\DKH\eBaySDK\Types\TokenType', false) ||
            is_subclass_of($meta->phpObject, '\DKH\eBaySDK\Types\URIType', false)
        );
    }
    ...
    {
        if (is_subclass_of($meta->phpObject, '\DKH\eBaySDK\Types\Base64BinaryType', false)) {
            return $meta->strData;
        } elseif (is_subclass_of($meta->phpObject, '\DKH\eBaySDK\Types\BooleanType', false)) {
            return strtolower($meta->strData) === 'true';
        } elseif (is_subclass_of($meta->phpObject, '\DKH\eBaySDK\Types\DecimalType', false)) {
            return is_int(0 + $meta->strData) ? (integer)$meta->strData : (double)$meta->strData;
        } elseif (is_subclass_of($meta->phpObject, '\DKH\eBaySDK\Types\DoubleType', false)) {
            return (double)$meta->strData;
        } elseif (is_subclass_of($meta->phpObject, '\DKH\eBaySDK\Types\IntegerType', false)) {
            return (integer)$meta->strData;
        } elseif (is_subclass_of($meta->phpObject, '\DKH\eBaySDK\Types\StringType', false)) {
            return $meta->strData;
        } elseif (is_subclass_of($meta->phpObject, '\DKH\eBaySDK\Types\TokenType', false)) {
            return $meta->strData;
        } elseif (is_subclass_of($meta->phpObject, '\DKH\eBaySDK\Types\URIType', false)) {
            return $meta->strData;
        }
