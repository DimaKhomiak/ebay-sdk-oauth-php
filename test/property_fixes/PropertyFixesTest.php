...
class PropertyFixesTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCancelSummary()
    {
        ...
        $this->assertInstanceOf('\DKH\eBaySDK\Types\RepeatableType', $obj->lineItems);
    }
    ...
    public function testDeliveryCost()
    {
        ...
        $this->assertInstanceOf('\DKH\eBaySDK\Fulfillment\Types\Amount', $obj->discountAmount);
    }
    ...
    public function testPriceDiscount()
    {
        ...
        $this->assertInstanceOf('\DKH\eBaySDK\Fulfillment\Types\Amount', $obj->priceDiscount);
    }

    public function testPriceDiscountSubtotalDoesNotExist()
    {
        $this->setExpectedException('\DKH\eBaySDK\Exceptions\UnknownPropertyException', 'Unknown property');
