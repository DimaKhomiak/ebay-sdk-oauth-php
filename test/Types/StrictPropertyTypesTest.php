...
class StrictPropertyTypesTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        \DKH\eBaySDK\Sdk::$STRICT_PROPERTY_TYPES = false;
        $this->obj = new ComplexClass();
    }

    protected function tearDown()
    {
        \DKH\eBaySDK\Sdk::$STRICT_PROPERTY_TYPES = true;
    }
    ...
    /**
     * @expectedException \DKH\eBaySDK\Exceptions\InvalidPropertyTypeException
     */
