...
class SimpleClassTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\DKH\eBaySDK\Test\Mocks\SimpleClass', $this->obj);
    }
    ...
    public function testGettingSettingProperties()
    {
        ...
        $this->assertInstanceOf('\DKH\eBaySDK\Test\Mocks\SimpleClass', $this->obj->SimpleClass);

        $this->assertEquals(0, count($this->obj->strings));
        $this->assertInstanceOf('\DKH\eBaySDK\Types\RepeatableType', $this->obj->strings);
        ...
        $this->assertInstanceOf('\DKH\eBaySDK\Types\RepeatableType', $this->obj->integers);
        ...
        $this->assertInstanceOf('\DKH\eBaySDK\Types\RepeatableType', $this->obj->anyTypes);
        $this->obj->anyTypes[] = 1;
    ...
    {
        $this->setExpectedException('\DKH\eBaySDK\Exceptions\UnknownPropertyException', 'Unknown property foo');
    ...
    {
        $this->setExpectedException('\DKH\eBaySDK\Exceptions\InvalidPropertyTypeException', 'Invalid property type provided for integer. Expected integer but got string');
    ...
    {
        $this->setExpectedException('\DKH\eBaySDK\Exceptions\InvalidPropertyTypeException', 'Invalid property type provided for integers. Expected integer but got string');
    ...
    {
        $this->setExpectedException('\DKH\eBaySDK\Exceptions\InvalidPropertyTypeException', 'Invalid property type provided for integers. Expected DKH\eBaySDK\Types\RepeatableType but got integer');
    ...
    public function testCanGetElementMeta()
    {
        ...
        $meta->phpType = 'DKH\eBaySDK\Test\Mocks\SimpleClass';
