...
use DKH\eBaySDK\Types\RepeatableType;
...
class RepeatableTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\DKH\eBaySDK\Types\RepeatableType', $this->obj);
    }
    ...
    {
        $this->setExpectedException('\DKH\eBaySDK\Exceptions\InvalidPropertyTypeException', 'Invalid property type provided for . Expected string but got integer');
