<?php
namespace DKH\eBaySDK\Test\FileTransfer\Services;

use DKH\eBaySDK\FileTransfer\Services\FileTransferService;
use DKH\eBaySDK\FileTransfer\Types;
...
class AttachmentTest extends \PHPUnit_Framework_TestCase
{
    public function testAttachmentFieldIsSetCorrectlyInRequest()
    {
        ...
        $this->assertEquals(null, $r->fileAttachment);
        $s->uploadFile($r);
        $this->assertInstanceOf('\DKH\eBaySDK\FileTransfer\Types\FileAttachment', $r->fileAttachment);
        $this->assertInstanceOf('\DKH\eBaySDK\FileTransfer\Types\Data', $r->fileAttachment->Data);
        $this->assertInstanceOf('\DKH\eBaySDK\FileTransfer\Types\XopInclude', $r->fileAttachment->Data->xopInclude);
