...
use DKH\eBaySDK\BulkDataExchange\Types\GetRecurringJobsResponse;
...
class GetRecurringJobsResponseTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\DKH\eBaySDK\BulkDataExchange\Types\GetRecurringJobsResponse', $this->obj);
    }
