...
use DKH\eBaySDK\BulkDataExchange\Enums\IncludeShippingAddressType;
...
class IncludeShippingAddressTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\DKH\eBaySDK\BulkDataExchange\Enums\IncludeShippingAddressType', $this->obj);
    }
}
