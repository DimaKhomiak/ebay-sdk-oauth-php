<?php
namespace DKH\eBaySDK\Test\MerchantData;

use DKH\eBaySDK\MerchantData\MerchantData;
...
class MerchantDataTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\DKH\eBaySDK\MerchantData\MerchantData', $this->merchantData);
    }

    public function testActiveInventoryReport()
    {
        $xml = file_get_contents(__DIR__.'/Mocks/ActiveInventoryReport.xml');
        $this->assertInstanceOf('\DKH\eBaySDK\MerchantData\Types\ActiveInventoryReportResponseType', $this->merchantData->activeInventoryReport($xml));
    }
    ...
    public function testAddFixedPriceItem()
    {
        ...
        $this->assertInstanceOf('\DKH\eBaySDK\Types\RepeatableType', $responses);
        $this->assertEquals(2, count($responses));
        foreach ($responses as $response) {
            $this->assertInstanceOf('\DKH\eBaySDK\MerchantData\Types\AddFixedPriceItemResponseType', $response);
        }
    }
    ...
    public function testAddItem()
    {
        ...
        $this->assertEquals(2, count($responses));
        foreach ($responses as $response) {
            $this->assertInstanceOf('\DKH\eBaySDK\MerchantData\Types\AddItemResponseType', $response);
        }
    }
    ...
    public function testEndFixedPriceItem()
    {
        ...
        $this->assertEquals(2, count($responses));
        foreach ($responses as $response) {
            $this->assertInstanceOf('\DKH\eBaySDK\MerchantData\Types\EndFixedPriceItemResponseType', $response);
        }
    }
    ...
    public function testEndItem()
    {
        ...
        $this->assertEquals(2, count($responses));
        foreach ($responses as $response) {
            $this->assertInstanceOf('\DKH\eBaySDK\MerchantData\Types\EndItemResponseType', $response);
        }
    }
    ...
    public function testFeeSettlementReport()
    {
        ...
        $this->assertInstanceOf('\DKH\eBaySDK\MerchantData\Types\FeeSettlementReportResponseType', $this->merchantData->feeSettlementReport($xml));
    }
    ...
    public function testOrderAck()
    {
        ...
        $this->assertEquals(2, count($responses));
        foreach ($responses as $response) {
            $this->assertInstanceOf('\DKH\eBaySDK\MerchantData\Types\OrderAckResponseType', $response);
        }
    }
    ...
    public function testRelistFixedPriceItem()
    {
        ...
        $this->assertEquals(2, count($responses));
        foreach ($responses as $response) {
            $this->assertInstanceOf('\DKH\eBaySDK\MerchantData\Types\RelistFixedPriceItemResponseType', $response);
        }
    }
    ...
    public function testRelistItem()
    {
        ...
        $this->assertEquals(2, count($responses));
        foreach ($responses as $response) {
            $this->assertInstanceOf('\DKH\eBaySDK\MerchantData\Types\RelistItemResponseType', $response);
        }
    }
    ...
    public function testReviseFixedPriceItem()
    {
        ...
        $this->assertEquals(2, count($responses));
        foreach ($responses as $response) {
            $this->assertInstanceOf('\DKH\eBaySDK\MerchantData\Types\ReviseFixedPriceItemResponseType', $response);
        }
    }
    ...
    public function testReviseInventoryStatus()
    {
        ...
        $this->assertEquals(2, count($responses));
        foreach ($responses as $response) {
            $this->assertInstanceOf('\DKH\eBaySDK\MerchantData\Types\ReviseInventoryStatusResponseType', $response);
        }
    }
    ...
    public function testReviseItem()
    {
        ...
        $this->assertEquals(2, count($responses));
        foreach ($responses as $response) {
            $this->assertInstanceOf('\DKH\eBaySDK\MerchantData\Types\ReviseItemResponseType', $response);
        }
    }
    ...
    public function testSetShipmentTrackingInfo()
    {
        ...
        $this->assertEquals(2, count($responses));
        foreach ($responses as $response) {
            $this->assertInstanceOf('\DKH\eBaySDK\MerchantData\Types\SetShipmentTrackingInfoResponseType', $response);
        }
    }
    ...
    public function testSoldReport()
    {
        ...
        $this->assertInstanceOf('\DKH\eBaySDK\MerchantData\Types\SoldReportResponseType', $this->merchantData->soldReport($xml));
    }
    ...
    public function testUploadSiteHostedPictures()
    {
        ...
        $this->assertEquals(2, count($responses));
        foreach ($responses as $response) {
            $this->assertInstanceOf('\DKH\eBaySDK\MerchantData\Types\UploadSiteHostedPicturesResponseType', $response);
        }
    }
    ...
    public function testVerifyAddFixedPriceItem()
    {
        ...
        $this->assertEquals(2, count($responses));
        foreach ($responses as $response) {
            $this->assertInstanceOf('\DKH\eBaySDK\MerchantData\Types\VerifyAddFixedPriceItemResponseType', $response);
        }
    }
    ...
    public function testVerifyAddItem()
    {
        ...
        $this->assertEquals(2, count($responses));
        foreach ($responses as $response) {
            $this->assertInstanceOf('\DKH\eBaySDK\MerchantData\Types\VerifyAddItemResponseType', $response);
        }
    }
}
