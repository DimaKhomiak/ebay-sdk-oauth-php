...
use DKH\eBaySDK\MerchantData\Enums\PayPalAccountStatusCodeType;
...
class PayPalAccountStatusCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\DKH\eBaySDK\MerchantData\Enums\PayPalAccountStatusCodeType', $this->obj);
    }
}
