...
use DKH\eBaySDK\MerchantData\Enums\BuyerProtectionSourceCodeType;
...
class BuyerProtectionSourceCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\DKH\eBaySDK\MerchantData\Enums\BuyerProtectionSourceCodeType', $this->obj);
    }
}
