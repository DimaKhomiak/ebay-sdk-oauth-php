...
use DKH\eBaySDK\MerchantData\Enums\RequiredSellerActionCodeType;
...
class RequiredSellerActionCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\DKH\eBaySDK\MerchantData\Enums\RequiredSellerActionCodeType', $this->obj);
    }
}
