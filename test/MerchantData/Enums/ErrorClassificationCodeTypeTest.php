...
use DKH\eBaySDK\MerchantData\Enums\ErrorClassificationCodeType;
...
class ErrorClassificationCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\DKH\eBaySDK\MerchantData\Enums\ErrorClassificationCodeType', $this->obj);
    }
}
