...
use DKH\eBaySDK\MerchantData\Enums\RefundingSourceTypeCodeType;
...
class RefundingSourceTypeCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\DKH\eBaySDK\MerchantData\Enums\RefundingSourceTypeCodeType', $this->obj);
    }
}
