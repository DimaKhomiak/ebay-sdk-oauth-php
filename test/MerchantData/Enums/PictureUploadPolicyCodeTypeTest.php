...
use DKH\eBaySDK\MerchantData\Enums\PictureUploadPolicyCodeType;
...
class PictureUploadPolicyCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\DKH\eBaySDK\MerchantData\Enums\PictureUploadPolicyCodeType', $this->obj);
    }
}
