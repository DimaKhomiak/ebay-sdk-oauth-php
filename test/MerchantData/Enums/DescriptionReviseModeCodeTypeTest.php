...
use DKH\eBaySDK\MerchantData\Enums\DescriptionReviseModeCodeType;
...
class DescriptionReviseModeCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\DKH\eBaySDK\MerchantData\Enums\DescriptionReviseModeCodeType', $this->obj);
    }
}
