...
use DKH\eBaySDK\MerchantData\Enums\ReasonHideFromSearchCodeType;
...
class ReasonHideFromSearchCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\DKH\eBaySDK\MerchantData\Enums\ReasonHideFromSearchCodeType', $this->obj);
    }
}
