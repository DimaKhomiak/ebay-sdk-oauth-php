...
use DKH\eBaySDK\Trading\Enums\DisputeCreditEligibilityCodeType;
...
class DisputeCreditEligibilityCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\DKH\eBaySDK\Trading\Enums\DisputeCreditEligibilityCodeType', $this->obj);
    }
}
