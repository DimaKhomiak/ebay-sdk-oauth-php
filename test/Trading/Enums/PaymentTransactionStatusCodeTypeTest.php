...
use DKH\eBaySDK\Trading\Enums\PaymentTransactionStatusCodeType;
...
class PaymentTransactionStatusCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\DKH\eBaySDK\Trading\Enums\PaymentTransactionStatusCodeType', $this->obj);
    }
}
