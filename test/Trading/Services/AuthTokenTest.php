<?php
namespace DKH\eBaySDK\Test\Trading\Services;

use DKH\eBaySDK\Trading\Services\TradingService;
...
class AuthTokenTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testAuthTokenIsUsedInRequst()
    {
        ...
        $this->assertInstanceOf('\DKH\eBaySDK\Trading\Types\CustomSecurityHeaderType', $r->RequesterCredentials);
