<?php
namespace DKH\eBaySDK\Parser\Test;
...
class XmlTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $xmlParser = new XmlParser('\DKH\eBaySDK\Test\Mocks\ComplexClass');
        $xml = file_get_contents(__DIR__.'/../Mocks/Response.xml');
        $xml = preg_replace('/[\n\r]/', '', $xml);
        $xml = preg_replace('/>\s+/', '>', $xml);
        $obj = $xmlParser->parse($xml);

        $this->assertInstanceOf('\DKH\eBaySDK\Test\Mocks\ComplexClass', $obj);
        ...
        $this->assertEquals('bar', $obj->strings[1]);
        $this->assertInstanceOf('\DKH\eBaySDK\Test\Mocks\SimpleClass', $obj->simpleClasses[0]);
        $this->assertEquals(888, $obj->simpleClasses[0]->integer);
        $this->assertInstanceOf('\DKH\eBaySDK\Test\Mocks\SimpleClass', $obj->simpleClasses[1]);
