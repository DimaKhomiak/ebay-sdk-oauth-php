...
use DKH\eBaySDK\ReturnManagement\Enums\NotificationEventNameType;
...
class NotificationEventNameTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\DKH\eBaySDK\ReturnManagement\Enums\NotificationEventNameType', $this->obj);
    }
}
